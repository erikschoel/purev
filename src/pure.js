      ...
      (function() {
        return {
          ...
          // === VALUES ETC === //
            ...
            (function index(key) {
              return this._store ? this._store.index(key) : -1;
            }),
            (function ids() {
              return this._store ? this._store.ids() : [];
            }),
            (function keys(index) {
              return this._store ? this._store.keys(index) : [];
            }),
            (function vals() {
              return this._store ? this._store.vals() : [];
            }),
            (function length() {
              return this._store ? this._store.length() : 0;
            }),
            (function select() {
